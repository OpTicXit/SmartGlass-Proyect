...
import com.smartglass.database.GestorArchivos;
...
public class RegisterFrame extends JFrame {
    ...
    private void manejarRegistro() {
        ...
        // Registrar el usuario en la base de datos simulada
        BaseDatosSimulada.agregarUsuario(campoNombre.getText(), correo, contraseña);
